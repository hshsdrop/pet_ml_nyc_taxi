...
- Фронтенд развернут на Streamlit.share, посетите [страницу с пет-проектом](https://front-ny-taxi.streamlit.app/). 
- Бэкенд развернут на платформе platform.sh, смотрите [документацию](https://main-bvxea6i-k4o37wg5i6vqs.de-2.platformsh.site/docs).

### О проекте
#### 1. Подготовка данных
Датасет из этого [соревнования](https://www.kaggle.com/c/nyc-taxi-trip-duration).
...
Район Нью-Йорка Манхэттен был выбран из-за небольшой поисковой области, т.к. быстрее ищется оптимальный маршрут. У сервиса построения оптимального маршрута есть ограничения по производительности.
...
Функция потерь MSLE, так как нам нужна функция, которая штрафует за недопрогнозирование больше, чем за переопрогнозирование.  
